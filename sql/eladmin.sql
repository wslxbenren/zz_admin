...
CREATE TABLE `dept` (
  ...
  `enabled` bit(1) NOT NULL,
   ...
   `GRAGE` varchar(255) DEFAULT NULL COMMENT '',
   `PARENT_ID` varchar(255) DEFAULT NULL COMMENT '',
   `SEQ` varchar(255) DEFAULT NULL COMMENT '',
   `DEP_ABB` varchar(255) DEFAULT NULL COMMENT '',
   `NOTE` varchar(255) DEFAULT NULL COMMENT '',
   `AMOUNT` varchar(255) DEFAULT NULL COMMENT '',
   `N_LAST_UPDATE_TIME` varchar(255) DEFAULT NULL COMMENT '',
   `DELETE_FLAG` varchar(255) DEFAULT NULL COMMENT '',
  PRIMARY KEY (`id`)
...
-- Records of dept
-- ----------------------------
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('1', 'eladmin', '0', '2019-03-25 09:14:05', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('2', '研发部', '7', '2019-03-25 09:15:32', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled)VALUES ('5', '运维部', '7', '2019-03-25 09:20:44', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('6', '测试部', '8', '2019-03-25 09:52:18', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('7', '华南分部', '1', '2019-03-25 11:04:50', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('8', '华北分部', '1', '2019-03-25 11:04:53', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('9', '财务部', '7', '2019-03-25 11:05:34', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('10', '行政部', '8', '2019-03-25 11:05:58', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('11', '人事部', '8', '2019-03-25 11:07:58', '');
INSERT INTO `dept` (id,name,pid,create_time,enabled) VALUES ('12', '市场部', '7', '2019-03-25 11:10:24', '\0');
...
CREATE TABLE `user` (
  ...
  `NAME_BRIEF_SPELL` varchar(255) DEFAULT NULL,
  ...
  `DISPLAY_FLAG` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` (id,avatar,create_time,email,enabled,password,username,last_password_reset_time,dept_id,phone,job_id) VALUES ('1', 'https://i.loli.net/2019/04/04/5ca5b971e1548.jpeg', '2018-08-23 09:11:56', 'admin@eladmin.net', '1', 'e10adc3949ba59abbe56e057f20f883e', 'admin', '2019-05-18 17:34:21', '2', '18888888888', '11');
INSERT INTO `user` (id,avatar,create_time,email,enabled,password,username,last_password_reset_time,dept_id,phone,job_id) VALUES ('3', 'https://aurora-1255840532.cos.ap-chengdu.myqcloud.com/8918a306ea314404835a9196585c4b75.jpeg', '2018-12-27 20:05:26', 'test@eladmin.net', '1', 'e10adc3949ba59abbe56e057f20f883e', 'test', '2019-04-01 09:15:24', '2', '17777777777', '12');
INSERT INTO `user` (id,avatar,create_time,email,enabled,password,username,last_password_reset_time,dept_id,phone,job_id) VALUES ('5', 'https://aurora-1255840532.cos.ap-chengdu.myqcloud.com/8918a306ea314404835a9196585c4b75.jpeg', '2019-04-02 10:07:12', 'hr@eladmin.net', '1', 'e10adc3949ba59abbe56e057f20f883e', 'hr', null, '11', '15555555555', '8');
